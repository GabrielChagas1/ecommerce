                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlspecialchars( $value1["desnamecorporate"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                        <td><?php echo htmlspecialchars( $value1["descnpj"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                        <td><?php echo htmlspecialchars( $value1["destelephone"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                        <td>
