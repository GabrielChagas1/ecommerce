...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>Carhartt Company</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/providers"><i class="fa fa-folder-open"></i> <span>Fornecedores</span></a></li>
        <li><a href="/admin/products"><i class="fa fa-gamepad"></i> <span>Produtos</span></a></li>
        <li><a href="/admin/orders"><i class="fa fa-external-link-square"></i> <span>Pedidos</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
