  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="box-header with-border">
          ...
          <a href="/admin/users" class="btn btn-danger" style="float: right;"><i class="fa fa-arrow-left"></i> Voltar</a>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control senha" id="despassword" name="despassword" placeholder="Digite sua senha" value="<?php echo htmlspecialchars( $user["despassword"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
              </div>
            <div class="checkbox">
              <label>
